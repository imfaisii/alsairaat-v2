                    ...
                    <li class="nav-item nav-search">
                        ...
                        <div class="search-input">
                            ...
                            <input class="form-control input" type="text"
                                placeholder="Explore {{ config('app.name') }}..." tabindex="-1" data-search="search">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        <div class="user-nav d-sm-flex d-none">
                            ...
                            <span class="user-status" style="margin-top: 6px;">{{ ucwords($user->role) }}</span>
                        </div>
                        <span class="avatar">
            ...
            <a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
                <div class="d-flex align-items-center">
                    <div class="avatar me-75">
                        <img src="{{ asset('app-assets/images/portrait/small/avatar-s-8.jpg') }}" alt="png"
                            height="32">
                    </div>
                    <div class="search-data">
