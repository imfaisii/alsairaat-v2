            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                @can('is-sa')
                    ...
                    <li class="nav-item @if (Route::is('society.management')) open @endif">
                        ...
                        @can('is-s')
                            <ul class="menu-content">
                                <li @if (Route::is('society.management.assign')) class="active" @endif>
                                    <a class="d-flex align-items-center" href="{{ route('society.management.assign') }}">
                                        <i data-feather="circle"></i>
                    ...
                    <li class="nav-item @if (Route::is('expense.management')) open @endif">
                        <a class="d-flex align-items-center" href="#">
                            <i data-feather="credit-card"></i>
                            <span class="menu-title text-truncate" data-i18n="Invoice">Expenses</span>
                        </a>
                        <ul class="menu-content">
                            <li @if (Route::is('expense.types.management')) class="active" @endif>
                                <a class="d-flex align-items-center" href="{{ route('expense.types.management') }}">
                                    <i data-feather="circle"></i>
                        ...
                        <ul class="menu-content">
                            <li @if (Route::is('expense.management')) class="active" @endif>
                                <a class="d-flex align-items-center" href="{{ route('expense.management') }}">
                                    <i data-feather="circle"></i>
                                    <span class="menu-item text-truncate" data-i18n="List">Create/View</span>
                                </a>
                            </li>
