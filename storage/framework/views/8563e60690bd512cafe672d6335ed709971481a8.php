                ...
                <form id="editUserForm" class="row gy-1 pt-75" onsubmit="return false">
                    <div class="col-12 col-md-12">
                        ...
                        <input wire:model.lazy='plot.name' type="text"
                            class="form-control <?php $__errorArgs = ['plot.name'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Some Type Name">
                        <?php $__errorArgs = ['plot.name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH C:\laragon\www\alsairaat\resources\views/livewire/dashboard/plot-type-management/create-component.blade.php ENDPATH**/ ?>