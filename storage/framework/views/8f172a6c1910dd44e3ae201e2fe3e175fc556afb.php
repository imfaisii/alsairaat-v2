...
unset($__errorArgs, $__bag); ?>" placeholder="john@example.com"
        ...
        <div class="mb-1">
            ...
            <div class="input-group input-group-merge form-password-toggle">
                <input wire:model.lazy="user.password" type="password"
                    class="form-control form-control-merge <?php $__errorArgs = ['user.password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
</div><?php /**PATH C:\laragon\www\alsairaat\resources\views/livewire/auth/login.blade.php ENDPATH**/ ?>