                        ...
                        <div class="row">
                            <div class="col-xl-2 col-sm-4 col-12 mb-2 mb-xl-0">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="my-auto">
                                        <h4 class="fw-bolder mb-0"><?php echo e($statistics['users']); ?></h4>
                            ...
                            <div class="col-xl-2 col-sm-4 col-12 mb-2 mb-sm-0">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="my-auto">
                                        <h4 class="fw-bolder mb-0"><?php echo e($statistics['societies']); ?></h4>
                            ...
                            <div class="col-xl-2 col-sm-4 col-12 mb-2 mb-xl-0">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="my-auto">
                                        <h4 class="fw-bolder mb-0"><?php echo e($statistics['plotsSold']); ?></h4>
                            ...
                            <div class="col-xl-2 col-sm-4 col-12">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="my-auto">
                                        <h4 class="fw-bolder mb-0"><?php echo e($statistics['plotsNotSold']); ?></h4>
                            ...
                            <div class="col-xl-2 col-sm-4 col-12">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="my-auto">
                                        <h4 class="fw-bolder mb-0">RS : <?php echo e($statistics['yearlySale']); ?></h4>
                                        <p class="card-text font-small-3 mb-0"><?php echo e(date('Y')); ?> Sale</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-sm-4 col-12">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="font-small-2 text-muted">in 2
                                                    days</span>
                                            </div>
                                        </td>
                                        <td>$668.51</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="font-small-2 text-muted">in 5
                                                    days</span>
                                            </div>
                                        </td>
                                        <td>$522.29</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="font-small-2 text-muted">in 1
                                                    week</span>
                                            </div>
                                        </td>
                                        <td>$783.93</td>
...
<?php /**PATH C:\laragon\www\alsairaat\resources\views/livewire/dashboard/home.blade.php ENDPATH**/ ?>