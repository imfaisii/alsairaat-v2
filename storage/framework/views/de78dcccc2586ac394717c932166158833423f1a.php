...
<title><?php echo e(config('app.name') . ' | ' . ucwords(last(request()->segments()))); ?></title>
...
<!-- END: Custom CSS-->
<?php /**PATH C:\laragon\www\alsairaat\resources\views/partials/app/styles.blade.php ENDPATH**/ ?>